<div class="page-body">
          ...
          <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <button type="button" class="btn btn-primary mb-5" onclick="add_jabatan()">Tambah Data</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Jabatan Form</h3>
            </div>
                ...
                <form action="#" id="form" class="needs-validation was-validated" novalidate="">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12 mb-5" id="input_biasa">
                          <label for="validationTooltip02">Nama Jabatan</label>
                          <input class="form-control" id="validationTooltip02" type="text" placeholder="Nama Jabatan" required="true" data-original-title="nama jabatan" title="Masukan nama jabatan" name="nama_jabatan">
                          <div class="invalid-tooltip">Pastikan Nama Jabatan  Benar</div>
                        </div>
