    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $layanan) {
            if($layanan->status =='0'){
                ...
                $btn = '<center><a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_layanan('."'".$layanan->id_performa."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                ...
                $status = 'Selesai';
                $btn = '<center><a class="btn btn-sm btn-info" href="javascript:void(0)" title="review" onclick="review_layanan('."'".$layanan->id_performa."'".')"><i class="glyphicon glyphicon-pencil"></i> Review</a>
                </center>';
            }
            $no++;
            $row = array();
